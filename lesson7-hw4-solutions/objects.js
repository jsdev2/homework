...
var binky = {
  ...
  noise: "Moo!",
  makeNoise: function() {
    // Embellished a bit from the instructions...
...
var animals = [
  new Animal("Sean", "dog", true, "Arf!"),
  new Animal("Matilda", "horse", false, "Neigh!"),
  new Animal("Horace", "lion", true, "Roar!"),
  binky
];
...
animals.forEach(function(animal) {
  ...
  if (animal.isCured) {
    console.log(animal.name + " is ready to go home.");
    animal.makeNoise();
  } else {
    console.log(animal.name + " is still sick.");
  }
});
